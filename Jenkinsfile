pipeline {
    ...
    post {
        always {
            ...
            httpRequest url: "https://api.meethue.com/bridge/x-kzNkJtqMcouSipwETUjiXkJP9BA7N-REZOp5yi/lights/1/state", httpMode: "PUT", requestBody: '{"on": true, "xy": [ 0.7, 0.25 ], "bri": 192, "transitiontime": 10 }', contentType: "APPLICATION_JSON", authentication: "Bearer HAP4qGpN8y1alDhringgPRN0B9F0"
        }
        success {
